    ...
    <div className="flex h-screen w-screen items-center justify-center">
      <div>
        {urlState?.startsWith("error_") ? (
          ...
          <Card className="m-4 mb-4 max-w-md border border-red-500 sm:m-0 sm:mb-4">
            <div className="flex items-center justify-between gap-4">
              <Card.Title className="text-red-500">{t("login.configurationIssue")}</Card.Title>
        ...
        <Card className="m-4 max-w-md sm:m-0">
          ...
          <Form method="POST">
            <Card.Text>
              {t("login.enterApiKeyPrefix")} <Code>headscale apikeys create</Code>{" "}
              {t("login.enterApiKeySuffix")}
            </Card.Text>
            <Input
              className="mt-8 mb-2"
              required
