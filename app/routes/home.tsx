      ...
      {loaderData.linkedUserName && (
        <Card variant="flat" className="flex max-w-2xl items-center gap-4">
          ...
          <Card.Text className="text-sm">
            {t("home.accountLinked", { user: loaderData.linkedUserName })}
          </Card.Text>
        </Card>
      )}
      <Card variant="flat" className="max-w-2xl">
        <Card.Title>{t("home.accessNetworkTitle")}</Card.Title>
        <Card.Text className="mt-1">{t("home.accessNetworkBody")}</Card.Text>
        ...
        >
          {loaderData.unlinked ? t("home.unlinkedAccount") : t("home.needDashboardAccess")}
        </Card.Text>
      </Card>
    </div>
  );
